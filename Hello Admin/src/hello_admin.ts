...
//  when if condition fail it will go on else condition
// Round bracket is at last, then comes curley bracket and then square bracket

const userNames: string[] = ['admin','Aamir','Asif','Bashir','Shabbir'];
